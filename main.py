...
class rts:
    ...
    def first_open_loop(self):
        ...
        while first_open_running:
            ...
            Utility.draw_center_text(self, f"Welcome to {self.GAME_NAME}!", Colors.TEXT_COLOR, self.SCREEN_HEIGHT / 2 - self.FONT_SIZE)        
            Utility.draw_center_text(self, "press SPACE or CLICK to begin!", Colors.TEXT_COLOR, self.SCREEN_HEIGHT - self.FONT_SIZE - 50)
    ...
    def race_select_loop(self):
        ...
        while race_select_running:
            ...
            goblin_button_rect = Utility.get_rect_with_center_text(self, "Goblin", self.font, self.MENU_FIRST_BUTTON, self.SCREEN_WIDTH)
            ...
            elf_button_rect = Utility.get_rect_with_center_text(self, "Elf", self.font, self.MENU_FIRST_BUTTON + (self.MENU_SPACING * 1), self.SCREEN_WIDTH)
            ...
            human_button_rect = Utility.get_rect_with_center_text(self, "Human", self.font, self.MENU_FIRST_BUTTON + (self.MENU_SPACING * 2), self.SCREEN_WIDTH)
            ...
            fae_button_rect = Utility.get_rect_with_center_text(self, "Fae", self.font, self.MENU_FIRST_BUTTON + (self.MENU_SPACING * 3), self.SCREEN_WIDTH)
            ...
            dwarf_button_rect = Utility.get_rect_with_center_text(self, "Dwarf", self.font, self.MENU_FIRST_BUTTON + (self.MENU_SPACING * 4), self.SCREEN_WIDTH)
    ...
    def pause_game_menu_loop(self):
        ...
        while pause_game_menu_loop_running:
            ...
            race_button_rect = Utility.get_rect_with_center_text(self, "Choose Race", self.font, self.MENU_FIRST_BUTTON, self.SCREEN_WIDTH)
            ...
            quit_button_rect = Utility.get_rect_with_center_text(self, "Quit", self.font, self.MENU_FIRST_BUTTON + (self.MENU_SPACING * 1), self.SCREEN_WIDTH)
    ...
    def main_game_loop(self):        
        ...
        while main_game_running:
            ...
            #  side panel
            side_panel_list, unit_list = Utility.create_side_panel(self, self.SIDE_PANEL_TEXT)
